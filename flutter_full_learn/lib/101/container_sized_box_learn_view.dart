...
/*
AppBar : Appbar'ı oluşturmak için kullanılır.
Sized Box
- Bir widget'ın boyutunu belirlemek için kullanılır.
- SizedBox.shrink() : Widget'ın boyutunu sıfırlar. Boş bir widget oluşturur.
- SizedBox.square() : Kare şeklinde bir widget oluşturur. dimension parametresi ile boyutu belirlenir.
*/