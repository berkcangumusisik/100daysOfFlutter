...
/**
 * Form widget'ı ile bir form oluşturabiliriz.
 * key: Form widget'ının key'i. GlobalKey ise formun global key'i. Formun durumunu kontrol etmek için kullanılır. 
 * autovalidateMode: Formun otomatik olarak doğrulanmasını sağlar.
 * DropdownButtonFormField: Bir dropdown button'ıdır. FormField widget'ıdır. Form widget'ı içerisinde kullanılabilir.
 */