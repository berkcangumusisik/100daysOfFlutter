...
/**
 * GlobalKey<FormState> _key = GlobalKey(); => FormState'ının bir referansını alır.
 * DropDownButton ile açılan menüde seçilen değeri alır.
 * CheckboxListTile ile elemanın durumunu değiştirir.
