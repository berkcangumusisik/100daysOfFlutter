...
/**
 AnimatedCrossFade 2 tane view arasında geçiş yapar.
 * firstChild: ilk görüntü
 * secondChild: ikinci görüntü
 * duration: geçiş süresi
 * crossFadeState: geçiş durumu
 AnimatedOpacity
 * Opacity değerini değiştirir.
 * duration: geçiş süresi
 * opacity: Opacity değeri
 AnimatedDefaultTextStyle
  * TextStyle değerini değiştirir.
 AnimatedIcon
  * AnimatedIcons sınıfından bir ikon alır.
  * progress: geçiş durumu
  * controller oluşturmak için TickerProviderStateMixin kullanılabilir.

 AnimatedContainer
  * Container değerlerini değiştirir.
  * duration: geçiş süresi
  * height: yükseklik
  * width: genişlik
  * color: renk
  * margin: margin
 AnimatedPositioned
  * Pozisyon değerlerini değiştirir.
  * duration: geçiş süresi
  * top: üst
  * bottom: alt
  * left: sol
